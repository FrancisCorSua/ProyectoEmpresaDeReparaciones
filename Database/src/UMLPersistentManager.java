...
public class UMLPersistentManager extends PersistentManager {
	private static final String PROJECT_NAME = "UML";
	...
	private UMLPersistentManager() throws PersistentException {
	...
	public static synchronized final PersistentManager instance() throws PersistentException {
		if (_instance == null) {
			_instance = new UMLPersistentManager();
		}
